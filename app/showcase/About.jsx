            ...
            <div className='p-4 md:w-1/3'>
              <div className='h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden'>
                ...
                <div className='p-6'>
                  ...
                  <h1 className='title-font text-lg font-medium text-gray-900 mb-3'>Lorem, ipsum.</h1>
        ...
        <div className='container px-5 py-10 mx-auto flex flex-wrap'>
          ...
          <div className='md:w-3/5 md:pl-6'>
            ...
            <div className='flex md:mt-4 mt-6'>
              <button className='inline-flex text-white bg-red-500 border-0 py-1 px-4 focus:outline-none hover:bg-red-600 rounded'>Button</button>
